                  ...
                  <div className="mt-2 flex items-center justify-center gap-2 sm:mt-4 sm:gap-2.5 sm:pt-2">
                    {isValidLink(member.linkedin) ? (
                      ...
                      <button
                        ...
                        className="inline-flex cursor-not-allowed items-center justify-center rounded-full border-2 border-neutral-400 bg-neutral-200 p-1.5 text-neutral-400 shadow-[2px_2px_0px_0px_rgba(0,0,0,0.4)] opacity-60 dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-600 sm:p-2"
                      >
                        <AiFillLinkedin className="h-5 w-5" />
                      </button>
                    )}
