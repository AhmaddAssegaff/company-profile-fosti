  ...
  return (
    <TabsContent className="flex flex-col gap-5" value="programs">
      ...
      <p className="max-w-3xl text-center text-sm font-semibold leading-relaxed text-neutral-600 dark:text-neutral-400 sm:text-start sm:text-base">
        Explore the various programs and initiatives led by the
        Organizational division. These programs aim to foster strong
        relationships, effective communication, and continuous growth within
        the community.
      </p>
