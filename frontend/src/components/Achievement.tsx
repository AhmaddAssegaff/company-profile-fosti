  ...
  return (
    <section id="achievements" className="mx-auto max-w-screen-2xl px-5 py-20">
      ...
      {achievements.length === 0 ? (
        <div className="mx-auto max-w-4xl rounded-2xl border-2 border-black bg-white py-16 text-center shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:border-white dark:bg-neutral-900 dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)]">
